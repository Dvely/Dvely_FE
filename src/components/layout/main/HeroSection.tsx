        ...
        <section className="relative w-full">
            ...
            <div className="relative z-10 flex justify-between items-center py-49">
                <div className="flex flex-col gap-2.5">
                    ...
                    <Button variant="outline" size="sm" className="border-[#767676] py-2.5 text-md font-semibold rounded-2xl w-[578px]">
                    ...
                    <div className="flex items-center gap-2.5">
                        <Button variant="outline" size="xs" className="rounded-full px-4">
                            <p className="font-semibold">에이전트 <span className="text-xs text-[#475569]">대화형 수정</span></p>
                        </Button>
                        <Button variant="outline" size="xs" className="rounded-full px-4">
                            <p className="font-semibold">ZIP·GitHub <span className="text-xs text-[#475569]">가져오기</span></p>
                        </Button>
                        <Button variant="outline" size="xs" className="rounded-full px-4">
                            <p className="font-semibold">빌드·배포 <span className="text-xs text-[#475569]">한 흐름</span></p>
                        </Button>
                    </div>
                </div>
