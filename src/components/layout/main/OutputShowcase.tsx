...
const showcaseItems: ShowcaseCardProps[] = [
    {
        cardBackgroundClassName:
            "bg-[linear-gradient(135deg,#1E293B_0%,#312E81_100%)]",
        ...
        <section className="w-full bg-white">
            <div className="flex flex-col gap-2 items-start justify-center py-16 px-52">
                ...
                <div className="flex justify-between w-full">
                    <p className="text-[#64748B] text-lg font-medium">아래는 스타일 레퍼런스용 목업입니다. 실제 생성물은 프롬프트<br />와 템플리셍 따라 달라집니다.</p>
                    <Button variant="link" className="text-[#7C3AED] text-md font-medium">템플릿 보러가기 {'->'}</Button>
                </div>
                <div className="grid grid-cols-3 gap-4 pt-5 w-full">
                    ...
                    <InfoCard
                        title="템플릿으로 시작하면"
                        description={
                            <p className="text-[#64748B] font-medium">카페·스튜디오·SaaS 등
                                <span className="text-[#111827] font-semibold">업종별 뼈대</span>
                                가 잡혀 있어 첫 프롬프트 부담이 줄어듭니다. 이후에는 섹션 추가·카피 교체만 반복하면 됩니다.</p>
                        }
