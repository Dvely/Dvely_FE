    ...
    return (
        <section className="w-full bg-[linear-gradient(180deg,#FDFBFF_0%,#F3EEFF_100%)]">
            <div className="flex flex-col gap-2 items-start justify-center py-16 px-52">
                ...
                <p className="text-[#111827] text-[40px] font-bold">아이디어부터 출시까지, AI와 함께하는 웹 제작</p>
                <p className="text-[#64748B] text-lg font-medium">짧은 주기로 초안을 만들고 검수·배포까지 잇는 도구입니다. 팀 단위 워크스페이스와 에이전트<br />대화를 기본으로 합니다.</p>
                ...
                <InfoCard
                    title={
                        <p className="text-[#475569] font-medium">
                            <span className="font-semibold ">워크플로 예시:</span>
                            새 프로젝트 생성 {'-> '} 
                            템플릿(랜딩·포트폴리오 등) 선택 {'-> '} 
                            세부 테마 지정 {'-> '} 
                            에이전트에서 문구·섹션 조정 {'-> '} 
